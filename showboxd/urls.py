...
urlpatterns = [
    ...
    # Discovery — dedicated endpoints, no frontend filtering
    path('nowshowing/',                 views.get_now_showing,    name='now_showing'),
    path('community-picks/',            views.get_community_picks,name='community_picks'),
